...
**What it is:** A set of 24 tools your AI agent can call on-demand to search, read, write, and manage your knowledge base. Seventeen are also exposed over HTTP; seven administrative or local-only tools are stdio-only.
...
Without the skill, your agent has 24 tools but no strategy for when to use them. It might:
...
| | MCP Server | Skill |
|---|---|---|
| **What** | 24 tools (search, read, write, capture...) | Instructions for using those tools efficiently |
...
Your agent now has all 24 KB tools.
